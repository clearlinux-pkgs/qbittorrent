...
Version  : 4.3.0.1
Release  : 16
URL      : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.3.0.1/qbittorrent-4.3.0.1.tar.xz
Source0  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.3.0.1/qbittorrent-4.3.0.1.tar.xz
Source1  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.3.0.1/qbittorrent-4.3.0.1.tar.xz.asc
...
%prep
%setup -q -n qbittorrent-4.3.0.1
cd %{_builddir}/qbittorrent-4.3.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603378864
...
cp %{_builddir}/qbittorrent-4.3.0.1/COPYING %{buildroot}/usr/share/package-licenses/qbittorrent/949ae914f4f5d1a0ac5f5d99c36b463cce3c69ca
%make_install
