...
Source0  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.4.3.1/qbittorrent-4.4.3.1.tar.xz
Source1  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.4.3.1/qbittorrent-4.4.3.1.tar.xz.asc
...
%prep
%setup -q -n qbittorrent-4.4.3.1
cd %{_builddir}/qbittorrent-4.4.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653583097
...
cp %{_builddir}/qbittorrent-4.4.3.1/COPYING %{buildroot}/usr/share/package-licenses/qbittorrent/95c8749dcb7934538595d05d60e4bc06dfabdb6d
%make_install
