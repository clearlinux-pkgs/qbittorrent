...
Source0  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.3.0/qbittorrent-4.3.0.tar.xz
Source1  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.3.0/qbittorrent-4.3.0.tar.xz.asc
...
%prep
%setup -q -n qbittorrent-4.3.0
cd %{_builddir}/qbittorrent-4.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603120527
...
cp %{_builddir}/qbittorrent-4.3.0/COPYING %{buildroot}/usr/share/package-licenses/qbittorrent/949ae914f4f5d1a0ac5f5d99c36b463cce3c69ca
%make_install
