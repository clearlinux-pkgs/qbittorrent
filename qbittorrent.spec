...
Source0  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.6.0/qbittorrent-4.6.0.tar.xz
Source1  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.6.0/qbittorrent-4.6.0.tar.xz.asc
...
%prep
%setup -q -n qbittorrent-4.6.0
cd %{_builddir}/qbittorrent-4.6.0
pushd ..
cp -a qbittorrent-4.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698071412
