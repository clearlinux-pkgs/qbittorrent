...
Version  : 4.4.3
Release  : 26
URL      : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.4.3/qbittorrent-4.4.3.tar.xz
Source0  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.4.3/qbittorrent-4.4.3.tar.xz
Source1  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.4.3/qbittorrent-4.4.3.tar.xz.asc
...
%prep
%setup -q -n qbittorrent-4.4.3
cd %{_builddir}/qbittorrent-4.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653341954
...
cp %{_builddir}/qbittorrent-4.4.3/COPYING %{buildroot}/usr/share/package-licenses/qbittorrent/95c8749dcb7934538595d05d60e4bc06dfabdb6d
%make_install
