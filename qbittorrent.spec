...
Source0  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.6.3/qbittorrent-4.6.3.tar.xz
Source1  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.6.3/qbittorrent-4.6.3.tar.xz.asc
...
%prep
%setup -q -n qbittorrent-4.6.3
cd %{_builddir}/qbittorrent-4.6.3
pushd ..
cp -a qbittorrent-4.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705504347
