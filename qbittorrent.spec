...
Version  : 4.2.3
Release  : 11
URL      : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.2.3/qbittorrent-4.2.3.tar.xz
Source0  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.2.3/qbittorrent-4.2.3.tar.xz
Source1  : https://sourceforge.net/projects/qbittorrent/files/qbittorrent/qbittorrent-4.2.3/qbittorrent-4.2.3.tar.xz.asc
...
%prep
%setup -q -n qbittorrent-4.2.3
cd %{_builddir}/qbittorrent-4.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585933796
...
cp %{_builddir}/qbittorrent-4.2.3/COPYING %{buildroot}/usr/share/package-licenses/qbittorrent/949ae914f4f5d1a0ac5f5d99c36b463cce3c69ca
%make_install
